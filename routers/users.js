    ...
    syncjson.forEach(tablelist => {
                  ...
                  if(response.statusCode==200)
                  {
                        ...
                        if(result.status)
                        {
                              if(item.OperationType!="delete")
                              {
                                ...
                                var options = {
                                      'method': 'PUT',
                                      'url': config.domain+'/users/'+result.data,
                                      'headers': {
                                        'Content-Type': 'application/json'
                                      },
         ...
         if(tablelist.tbl_role!=undefined)
         {
               ...
               tablelist.tbl_role.forEach(item => {
                  ...
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-role',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                if(item.OperationType!="delete")
                                {
                                  ...
                                  var options = {
                                        'method': 'PUT',
                                        'url': config.domain+'/users/role/'+result.data,
                                        'headers': {
                                          'Content-Type': 'application/json'
                                        },
                                        body: JSON.stringify(item)
         ...
         if(tablelist.tb_menufunc_access_right!=undefined)
         {
               ...
               tablelist.tb_menufunc_access_right.forEach(item => {
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-menufunc_access_right',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                if(item.OperationType!="delete")
                                {
                                  ...
                                  var options = {
                                        'method': 'PUT',
                                        'url': config.domain+'/users/menuaccessright/'+result.data,
                                        'headers': {
                                          'Content-Type': 'application/json'
                                        },
                                        body: JSON.stringify(item)
                              ...
                              else
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'POST',
                                          'url': config.domain+'/users/menuaccessright',
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
         ...
         if(tablelist.tb_menufunc!=undefined)
         {
               ...
               tablelist.tb_menufunc.forEach(item => {
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-menufunc',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'PUT',
                                          'url': config.domain+'/users/menufunc/'+result.data,
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
                              ...
                              else
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'POST',
                                          'url': config.domain+'/users/menufunc',
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'PUT',
                                          'url': config.domain+'/users/branch/'+result.data,
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'PUT',
                                          'url': config.domain+'/users/department/'+result.data,
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
         ...
         if(tablelist.tbl_staff_branch!=undefined)
         {
               ...
               tablelist.tbl_staff_branch.forEach(item => {
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-staff-branch',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                    if(item.OperationType!="delete")
                                    {
                                      ...
                                      var options = {
                                            'method': 'PUT',
                                            'url': config.domain+'/users/staff_branch/'+result.data,
                                            'headers': {
                                              'Content-Type': 'application/json'
                                            },
                                            body: JSON.stringify(item)
                              ...
                              else
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'POST',
                                          'url': config.domain+'/users/staff_branch',
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
         ...
         if(tablelist.tbl_staff_department!=undefined)
         {
               ...
               tablelist.tbl_staff_department.forEach(item => {
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-staff_department',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        body: JSON.stringify({"id":item.id})
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              else
                              {
                                  if(item.OperationType!="delete")
                                  {
                                    ...
                                    var options = {
                                          'method': 'POST',
                                          'url': config.domain+'/users/staff_department',
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                  if(item.OperationType=="update")
                                  {
                                      ...
                                      var options = {
                                        'method': 'PUT',
                                        'url': config.domain+'/users/legal_entity/'+result.data,
                                        'headers': {
                                          'Content-Type': 'application/json'
                                        },
                                        body: JSON.stringify(item)
         ...
         if(tablelist.tbl_staff_legal_entity!=undefined)
         {
               ...
               tablelist.tbl_staff_department.forEach(item => {
                  var options = {
                        'method': 'POST',
                        'url': config.domain+'/users/single-staff_legal_entity',
                        'headers': {
                          'Content-Type': 'application/json'
                        },
                        body: JSON.stringify({"id":item.id})
                        ...
                        if(response.statusCode==200)
                        {
                              ...
                              if(result.status)
                              {
                                  if(item.OperationType=="update")
                                  {
                                      ...
                                      var options = {
                                        'method': 'PUT',
                                        'url': config.domain+'/users/staff_legal_entity/'+result.data,
                                        'headers': {
                                          'Content-Type': 'application/json'
                                        },
                                        body: JSON.stringify(item)
                              ...
                              else
                              {
                                  if(item.OperationType!="delete" && item.OperationType!="insert")
                                  {
                                    ...
                                    var options = {
                                          'method': 'POST',
                                          'url': config.domain+'/users/staff_legal_entity',
                                          'headers': {
                                            'Content-Type': 'application/json'
                                          },
                                          body: JSON.stringify(item)
