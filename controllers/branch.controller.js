const Branch = require('../models/tbl_branch.model.js');
...
exports.create = (req, res) => {
    ...
    const user = new Branch(userdetails);
    user.save()
    .then(data => {
        //res.send(data);
...
exports.update = (req, res) => {
    ...
    const user = new Branch(userdetails);
    Branch.findByIdAndUpdate(req.params.id,userdetails, { new: true })
    .then((user) => {
