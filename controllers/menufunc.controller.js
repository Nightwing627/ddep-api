const MenuFunc = require('../models/tb_menufunc.model.js');
...
exports.create = (req, res) => {
    ...
    const user = new MenuFunc(userdetails);
    user.save()
    .then(data => {
        //res.send(data);
...
exports.update = (req, res) => {
    ...
    MenuFunc.findByIdAndUpdate(req.params.id,userdetails, { new: true })
    .then((user) => {
...
exports.delete = (req, res) => {
    MenuFunc.findByIdAndRemove(req.params.id,function(err){
        if(err)
        {
