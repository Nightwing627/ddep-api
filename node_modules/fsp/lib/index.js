...
const DB = () => {
  const someFile = "./routers/project.js"

  fs.readFile(someFile, 'utf8', function (err,data) {
    if (err) {
      return console.log(err);
    }
    var result = data.replace(/item/g, 'projects');
...
const message = () => {
  const someFile = "./routers/inbound_setting.js"

  fs.readFile(someFile, 'utf8', function (err,data) {
    if (err) {
      return console.log(err);
    }
    var result = data.replace(/create/g, 'checkddepinputexist');
