...
$(document).ready(function(){
    ...
    $('#btn_create_new_template').on('click',function(){
            ...
            $.ajax({  
                ...
                success:function(response){
                     ...
                     $.each(response.data,function(index,data){
                        ...
                        $button_group+='<button type="button" class="btn btn-secondary">View</button>';
                        if(data.isActive=="Active")
                        {
                            $button_group+='<button type="button" class="btn btn-success btn-status" data-value="'+data.isActive+'" data-id="'+data._id+'">Active</button>';
                        }
                        else
                        {
                            $button_group+='<button type="button" class="btn btn-secondary btn-status" data-value="'+data.isActive+'" data-id="'+data._id+'">InActive</button>';

                        }
                        $button_group+='<button type="button" class="btn btn-del-temp btn-danger" data-id="'+data._id+'">Delete</button></div>';
                        table.row.add( [
                         counter++,
                         data.TemplateCode,
                         data.TemplateName,
